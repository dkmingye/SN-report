 ...
 * @author ARK
 */
public class GRCReportViewUtility {
  ...
  public static Text getGlobalTitle(final MegaRoot megaRoot, final String sTitleCodeTemplate, final int iValue) {
    ...
    String title = "<p  style=\"font-weight:bold;text-align: center; color:#" + GRCColorsUtility.TITLE_COLOR + "; font-size:160%;\"> <b>" + codeTemplate + " : " + iValue + "</b> </p>";
  ...
  public static View getEmptyChartsView(final ReportContent reportContent, final boolean isPie, final String direction, final String title) {
    ...
    if (!isPie) {
      ...
      diagramView.addParameter("colors", GRCColorsUtility.NO_DATA_COLOR);
      ...
      GRCReportViewUtility.setTechParamPieChart(diagramView, true, "");
      diagramView.addParameter("legendformat", "{label}");
      diagramView.addParameter("labelformat", "");
      dimension1.addItem(new Text(GRCConstants.CT_NO_DATA, true), 1);
  ...
  public static void setTechParamPieChart(final View view, final boolean noData, final String colors) {
    GRCReportViewUtility.setTechParamPieChart(view, noData, colors, true);
  }

  public static void setTechParamPieChart(final View view, final boolean noData, final String colors, final boolean isCharttable) {
    view.addRenderer(AnalysisReportToolbox.rPieChart);

    if (noData) {
      view.addParameter("colors", GRCColorsUtility.NO_DATA_COLOR);
    } else {
    ...
    view.addParameter("labelformat", GRCConstants.DATA_LABEL_PERCENT);
  ...
  public static void setTechParamBar(final View viewBarChart, final boolean isHorizontal, final String colors, final String DataLabelFormat, final String stacked) {
    ...
    viewBarChart.addParameter("AggregateLabelFormat", "{value}");
  ...
  public static Text getDiagramTitle(final MegaRoot megaRoot, final String sTitleCodeTemplate) {
    String codeTemplate = GRCReportViewUtility.getCodeTemplate(sTitleCodeTemplate, megaRoot);
