...
public class RiskOperator {
	...
	public static boolean isKeyRisk(MegaObject risk){
		String keyRisk=risk.getProp("Key Risk");
		return keyRisk.equalsIgnoreCase("1")?true:false;
	}
	...
	public static String getComment(MegaObject risk){
		return risk.getProp("Comment", "Display").toString();
	}
	
	public static String getLossCalculation(MegaObject risk){
		return risk.getProp("Loss calculation", "Display").toString();
	}
