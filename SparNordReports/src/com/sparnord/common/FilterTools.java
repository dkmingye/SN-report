...
import com.sparnord.riskreport.RiskOperator;
import com.sparnord.riskreport.SystemLog;
...
public class FilterTools {
	...
	public static MegaCollection filterRisksByTypeDeeply(MegaRoot root,MegaCollection riskList, ArrayList<MegaObject> colRiskType ){	
		if(colRiskType.size()==0){
			return riskList;			
		}else {
			MegaCollection riskList_filtered = root.getSelection("");
	...
	public static MegaCollection filterKeyRisks(MegaRoot root, MegaCollection riskList,boolean keyRisk){		
	 ...
	 public static MegaCollection getAllSubRiskTypes(MegaRoot root,ArrayList<MegaObject> colRiskType){
